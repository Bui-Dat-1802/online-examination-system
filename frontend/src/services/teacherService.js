...
const teacherService = {
    ...
    getExamScores(classId, examInstanceId) {
        return axiosClient.get(
            `/teacher/classes/${classId}/exam-instances/${examInstanceId}/scores`
        );
    },
    ...
    getExamTemplatesByClass(classId) {
        return axiosClient.get(
            `/teacher/classes/${classId}/exam-templates`
        );
    },

    // exams theo lớp
    getExamInstances(classId) {
        return axiosClient.get(`/teacher/classes/${classId}/exam-instances`);
    },

    // HS đang thi
    getActiveStudents(classId) {
        return axiosClient.get(`/teacher/classes/${classId}/active-students`);
    },

    // Tiến độ thi
    getExamProgress(classId, examInstanceId) {
        return axiosClient.get(
            `/teacher/classes/${classId}/exam-instances/${examInstanceId}/progress`
        );
    },
    ...
    addAccommodation(examInstanceId, data) {
        return axiosClient.post(
            `/teacher/exam-instances/${examInstanceId}/accommodations`,
            data
        );
    },
    ...
    lockSession(sessionId, reason) {
        return axiosClient.post(`/teacher/exam-sessions/${sessionId}/lock`, { reason });
    },

    //endpoint 37
    unlockSession(sessionId, reason) {
        return axiosClient.post(`/teacher/exam-sessions/${sessionId}/unlock`, { reason });
    },
    ...
    createClass(data) {
        ...
        return axiosClient.post('/teacher/classes', data);
    },
    ...
    getClassDetail(id) {
        //1. Khi có backend
        return axiosClient.get(`/teacher/classes/${id}`);
    ...
    cleanupImportMedia(mediaUrls) {
        return axiosClient.post(
            "/teacher/questions/import/cleanup-media",
            { mediaUrls }
        );
    },
    ...
    deleteClass(id) {
        ...
        return axiosClient.delete(`/teacher/classes/${id}`);
    ...
    getEnrollmentRequests(classId) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.get(`/teacher/classes/${classId}/enrollment-requests`);
    ...
    respondToEnrollment(requestId, status) {
        ...
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.post('/teacher/enrollment-requests/approve', payload);
    ...
    getQuestions() {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.get('/teacher/questions');
    },
    ...
    createExamTemplate(data) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.post('/teacher/exam-templates', data);
    ...
    getExamTemplates() {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.get('/teacher/exam-templates');
    },

    // --- ENDPOINT 28: CHỈNH SỬA TEMPLATE ---
    updateExamTemplate(id, data) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.put(`/teacher/exam-templates/${id}`, data);
    ...
    deleteExamTemplate(id) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.delete(`/teacher/exam-templates/${id}`);
    },

    // --- THÊM ENDPOINT 30: TÌM KIẾM ---
    searchExamTemplates(keyword) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.get(`/teacher/exam-templates/search?keyword=${keyword}`);
    ...
    createExam(data) {
        // --- KHI CÓ BACKEND: Bỏ comment dòng này ---
        return axiosClient.post('/teacher/exam-instances', data);

    },

    // --- ENDPOINT 22: LẤY DS ĐỀ THI THEO TEMPLATE ---
    getExamInstancesByTemplate(templateId) {
        return axiosClient.get(`/teacher/exam-templates/${templateId}/exam-instances`);
    },

    // --- ENDPOINT 23: SỬA ĐỀ THI ---
    updateExamInstance(id, data) {
        // --- KHI CÓ BACKEND: Bỏ comment ---
        return axiosClient.put(`/teacher/exam-instances/${id}`, data);

    },

    // --- ENDPOINT 21: XÓA ĐỀ THI ---
    deleteExamInstance(id) {
        return axiosClient.delete(`/teacher/exam-instances/${id}`);
    },
    ...
    exportResults(examId) {
        ...
        return axiosClient.get(`/teacher/export/results/${examId}`, { responseType: 'blob' });
    },

    // --- ENDPOINT 42: XUẤT NHẬT KÝ THI (CSV) ---
    exportLogs(examId) {
        return axiosClient.get(`/teacher/export/logs/${examId}`, { responseType: 'blob' });
    },

    // --- ENDPOINT 45: XÓA HỌC SINH KHỎI LỚP ---
    removeStudentFromClass(classId, studentId) {
        return axiosClient.delete(`/teacher/classes/${classId}/students/${studentId}`);
    },
